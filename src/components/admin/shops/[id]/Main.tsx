...
import UpdateStatusShopModal from "@/components/admin/shops/UpdateStatusShopModal";
import {ShopView} from "@/types/interface";
import ScrollTab, {TabItem} from "@/libs/ScrollTab";
import General from "@/components/admin/shops/[id]/general/General";
import Orders from "@/components/admin/shops/[id]/orders/Orders";
import Reviews from "@/components/admin/shops/[id]/reviews/Reviews";
import Statistics from "@/components/admin/shops/[id]/statistics/Statistics";
        ...
        {shop.shopStatus === ShopStatus.SUSPENDED && (
          <div className="flex-1 flex items-center justify-center">
            <div className="bg-support-c100 border-2 border-support-c500 rounded-lg px-4 py-2 flex items-center gap-2">
              ...
              <span className="text-support-c900 font-semibold">Cửa hàng đã bị đình chỉ.</span>
            </div>
          </div>
        )}
