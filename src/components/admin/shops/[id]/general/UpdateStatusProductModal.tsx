...
export default function UpdateStatusProductModal({
  ...
  const isUpdatable = currentStatus === ProductStatus.ACTIVE || currentStatus === ProductStatus.INACTIVE || currentStatus === ProductStatus.SUSPENDED;

  const newStatus = isUpdatable
    ? (currentStatus === ProductStatus.SUSPENDED ? ProductStatus.INACTIVE : ProductStatus.SUSPENDED)
    : currentStatus;
