...
import TodayFlashSale from "@/components/owner/flash-sales/today/TodayFlashSale";
import TomorrowFlashSale from "@/components/owner/flash-sales/tomorrow/TomorrowFlashSale";
import AllFlashSale from "@/components/owner/flash-sales/all/AllFlashSale";
...
export default function Main() {
  ...
  const tabs: TabItem[] = [
    ...
    {key: "3", label: "Tất cả Flash Sale đã đăng ký"},
  ];
