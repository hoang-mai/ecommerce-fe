...
import General from "@/components/owner/shops/[id]/[productId]/general/General";
import Reviews from "@/components/owner/shops/[id]/[productId]/reviews/Reviews";
import Statistics from "@/components/owner/shops/[id]/[productId]/statistics/Statistics";
import {ShopStatus} from "@/types/enum";
import UpdateStatusProductModal from "@/components/owner/shops/[id]/general/UpdateStatusProductModal";
import UpdateProductModal from "@/components/owner/shops/[id]/general/UpdateProductModal";
...
export default function Main({productId}: Props) {
  ...
  const {data, error, isLoading, mutate} = useSWR(
    `${PRODUCT_VIEW}/${productId}?isOwner=true`,
    fetcher,
    {
      refreshInterval: 0,
